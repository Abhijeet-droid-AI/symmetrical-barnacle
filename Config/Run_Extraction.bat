...
rem  CSV_DB_QUERY and OUTPUT_FILE from classification_utilities.cfg. Its
rem  login credentials come from tc_config.txt (passed via -tcconfig=).
rem =============================================================================
...
if not exist "%EXE%" (
    ...
    echo         Build it first with Build_All.bat or from Visual Studio.
    goto :end
)
